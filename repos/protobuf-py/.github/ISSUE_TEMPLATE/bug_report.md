...
- **protobuf-py Version**: <!--[e.g., v1.0.2]-->
- **protobuf-py Plugin (`protoc-gen-py`) Version**: <!--[e.g., v1.0.2]-->
- **Python Version**: <!--[e.g., 3.14]-->
- **Protobuf Compiler & Version**: <!--[e.g. buf v1.63.0, protoc 33.4]-->
- **Operating System and Version**: <!--[e.g., macOS 10.15.7, Windows 10, Ubuntu 20.04]-->
